...
const pf = (v) =>
  ...
  // 15.2. Eliminador individual de registros del historial
  const undoTimerRef = useRef(null);
  const [undo, setUndo] = useState(null); 
  // undo = { index, record, committed: false }
...
// ═══════════════════════════════════════════════════════════════════════════════
// 8. COMPONENTE PRINCIPAL - FARMACLINIC MÁRGENES
// ═══════════════════════════════════════════════════════════════════════════════
